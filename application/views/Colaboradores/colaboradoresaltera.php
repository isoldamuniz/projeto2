      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-12 mb-5">
            ...
            <form action="<?=base_url('Colaboradores/atualizar/' . $this->uri->segment(3) . '/' . $colaboradorid['empresa_id'] . '/' . $colaboradorid['Id_colaborador'])?>" class="p-5 bg-white" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="nome" class="form-control" value="<?=$colaboradorid['nome']?>">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="cpf" class="form-control" value="<?=$colaboradorid['CPF']?>">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="email" class="form-control" value="<?=$colaboradorid['email']?>">
                </div>
              </div>
              ...
              <div class="row form-group mb-5">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                    <label for="option-gender-1">
                        <input type="radio" id="option-gender-1" value="Feminino" <?php if($colaboradorid['sexo']=='Feminino'){ echo "checked='true'";} ?> name="sexo"> Feminino
                    </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                    <label for="option-gender-1">
                        <input type="radio" id="option-gender-1" value="Masculino" <?php if($colaboradorid['sexo']=='Masculino'){ echo "checked='true'";} ?> name="sexo"> Masculino
                    </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                    <label for="option-gender-1">
                        <input type="radio" id="option-gender-1" value="Outro" <?php if($colaboradorid['sexo']=='Outro'){ echo "checked='true'";} ?> name="sexo"> Outro
                    </label>
                </div> 
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <a href="JavaScript: window.history.back();" class="btn btn-black  py-2 px-4">Cancelar</a></p>
                </div>
              </div>
            </form>
          </div>
